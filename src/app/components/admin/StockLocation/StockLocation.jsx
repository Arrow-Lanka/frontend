...
// sub components
import NewAndEditStockLocation from "./modals/NewAndEditStockLocation";
...
const StockLocation = () => {
  ...
  */  
    ...
    const ItemIconclickAction = (event) => {
        ...
        let clickeData =  ItemListPaginationData?.listData?.filter(
            (singleItem) => singleItem?.stockLocationId?.toString() === id.toString()
          );
  ...
  */ 
    useEffect(()=>{
        ...
        http_Request(
            {
              url: API_URL.stock_location.SEARCH_STOCK_LOCATION,
              method: "POST",
        ...
        <Card elevation={10}>
            <CardContent className={commonClasses.mainCardContainer}>
               ...
               <Grid container xs={12} md={12} display="flex" justifyContent='flex-start'>
                                   <Typography className={commonClasses?.resturantTitleWordTypo}>{"Stock Locations"}</Typography>
                               </Grid>
                ...
                <Grid container xs={12} display={"flex"} justifyContent='space-between' style={{marginTop:"10px"}}>
                    ...
                    <SearchComponent
                      ...
                      inputFieldText={
                         !ItemSearchFieldData?.isAdvanceSearch ? "Search By Name" : ""
                      }
                    />
                  </Grid>
                </Grid>
                ...
                <ConfirmationModal
                    ...
                    confirmationModalHeader="Inactive Stock Location"
